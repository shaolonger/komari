...
- [x] **K3-H101** ACK 仅在 durable 水位推进时发送，阻断旧 Agent 重放反馈环
- [x] **K3-H102** 发布 accepted/durable 双水位控制契约
- [x] **K3-H103** WebSocket 使用三个心跳周期的有界容错并补齐断线原因
- [x] **K3-H104** 修复并执行 v2.4 跨仓协议门禁
