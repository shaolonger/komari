...
- [ ] **K2-003 Add a checked-in versioned RPC contract and discovery manifest**
...
- [ ] **K2-305 Gate pinned official frontend builds on RPC compatibility**

## K2-4 Realtime and scale

- [ ] **K2-401 Expose resumable sequence delta subscriptions over RPC2**
...
- [ ] **K2-501 Real legacy/corrupt/orphan database migration matrix**
